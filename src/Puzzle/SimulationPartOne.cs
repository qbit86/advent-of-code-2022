...
internal sealed class SimulationPartOne
{
    ...
    private SimulationPartOne(HashSet<Point> rocks, IReadOnlySet<Point> sandUnits, int bottom)
    {
        _rocks = rocks;
    ...
    internal static SimulationPartOne Create(IReadOnlyList<string> lines, IReadOnlySet<Point> sandUnits)
    {
        ...
        return new(rocks, sandUnits, bottom);
    }
    ...
    private bool IsBottom(Point position) => position.Y >= Bottom;
}
